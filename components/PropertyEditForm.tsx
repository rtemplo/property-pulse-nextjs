    ...
    <form>
      ...
      <div className="mb-4">
        ...
        <textarea
          ...
          defaultValue={property.description ? property.description : ''}
        ></textarea>
      </div>
      ...
      <div className="mb-4 bg-blue-50 p-4">
        ...
        <input
          ...
          className="border rounded w-full py-2 px-3 mb-2"
          placeholder="Street"
          defaultValue={property.location?.street ? property.location.street : ''}
        />
        <input
          type="text"
          id="city"
          ...
          placeholder="City"
          required
          defaultValue={property.location?.city ? property.location.city : ''}
        />
        <input
          type="text"
          id="state"
          ...
          placeholder="State"
          required
          defaultValue={property.location?.state ? property.location.state : ''}
        />
        <input
          type="text"
          id="zipcode"
          ...
          className="border rounded w-full py-2 px-3 mb-2"
          placeholder="Zipcode"
          defaultValue={property.location?.zipcode ? property.location.zipcode : ''}
        />
      </div>
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
          ...
          <div className="flex items-center">
            ...
            <input
              ...
              name="rates.monthly"
              className="border rounded w-full py-2 px-3"
              defaultValue={property.rates?.monthly ? property.rates.monthly : ''}
            />
          </div>
          <div className="flex items-center">
            ...
            <input
              ...
              name="rates.nightly"
              className="border rounded w-full py-2 px-3"
              defaultValue={property.rates?.nightly ? property.rates.nightly : ''}
            />
          </div>
        </div>
      </div>
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className="border rounded w-full py-2 px-3"
          placeholder="Name"
          defaultValue={property.seller_info?.name ? property.seller_info.name : ''}
        />
      </div>
      <div className="mb-4">
        ...
        <input
          ...
          required
          defaultValue={property.seller_info?.email ? property.seller_info.email : ''}
        />
      </div>
      <div className="mb-4">
        ...
        <input
          ...
          className="border rounded w-full py-2 px-3"
          placeholder="Phone"
          defaultValue={property.seller_info?.phone ? property.seller_info.phone : ''}
        />
      </div>
